...
export type EditShiftFormFieldValues = z.infer<typeof ShiftSchema>;

export type EditShiftFormProps = {
  defaultValues?: EditShiftFormFieldValues & {
    joining_date: string;
  };
  companyId: string;
  loading: boolean;
...
export type FormRef = {
  submitForm: (
    onSubmit: (formValues: Partial<EditShiftFormFieldValues>) => void
  ) => void;
  setError: UseFormSetError<EditShiftFormFieldValues>;
};

const formDefaultValues: EditShiftFormFieldValues = {
  id: null,
  effective_from: null,
  effective_to: null,
...
export const EditShiftForm = forwardRef(
  (
    { defaultValues, loading, companyId, operationType }: EditShiftFormProps,
...
EditShiftForm.displayName = "ShiftForm";
