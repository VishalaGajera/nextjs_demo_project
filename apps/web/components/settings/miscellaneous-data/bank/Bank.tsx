...
import { AddBankDialog } from "./Dialogs/AddBankDialog";

export type BankListRef = {
  refreshBankList: () => void;
};

export function Bank() {
  const bankListRef = useRef<BankListRef>(null);
  ...
  const dialogRenderer: DialogRenderer = {
    add: (
      <AddBankDialog
        ...
        onAddSuccess={() => bankListRef.current?.refreshBankList()}
      />
    ),
  };
    ...
    <>
      ...
      >
        <Stack>
          ...
          <BankList ref={bankListRef} search={searchInput} />
        </Stack>
      </Box>
