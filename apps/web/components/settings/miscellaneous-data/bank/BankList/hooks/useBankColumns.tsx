...
import type { Bank } from "./useGetBanks";

type UseBankColumnsArgs = {
  onAction: (actionType: DialogTypes, rowData: Bank) => void;
};

export const useBankColumns = ({
  onAction,
  loading,
}: AgColumnsArgs<UseBankColumnsArgs>) => {
  const columns: AgColumnsWithActions<Bank> = [
    {
    ...
    },
    {
      ...
      filter: "agTextColumnFilter",
      sortable: true,
      cellRenderer: ({ data }: CustomCellRendererProps<Bank>) => {
        if (loading) {
          return <LoadingCell />;
        }
