...
import { useGetLoanCategoryOptions } from "../../../../../common/Autocomplete/hooks/useGetLoanCategoryOptions";
  ...
  const filterListItems: FilterListType[] = useMemo(
    () => [
      ...filterListItemsField,
      {
        ...
        value: currentFilter?.loan_category_id ?? "",
        type: "autoComplete",
        isDisabled: !currentFilter?.company_id,
        options: loanCategoryOptions,
      },
    ],
    [filterListItemsField, loanCategoryOptions]
  );
