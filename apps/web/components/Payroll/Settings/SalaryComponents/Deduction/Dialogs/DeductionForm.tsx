...
export type DeductionFormFieldValues = z.infer<typeof DeductionFormSchema>;

type DeductionFormProps = {
  defaultValues?: DeductionFormFieldValues;
  loading?: boolean;
};

export type FormRef = {
  submitForm: (
    onSubmit: (formValues: Partial<DeductionFormFieldValues>) => void
  ) => void;
  setError: UseFormSetError<DeductionFormFieldValues>;
};

const formDefaultValues: DeductionFormFieldValues = {
  company_id: null,
...
export const DeductionForm = forwardRef(
  (
    { defaultValues = formDefaultValues, loading = false }: DeductionFormProps,
      ...
      <Stack gap="16px">
        ...
        <FormRow maxColumn={2}>
          ...
          <DeductionComponentAutocomplete
            ...
            helperText={errorMessages(errors.deduction_component_type?.message)}
          />
        </FormRow>
        ...
        <FormRow maxColumn={2}>
          <TextField
            ...
            helperText={errorMessages(errors.deduction_component_code?.message)}
            required
          />
          ...
          <TextField
            ...
            helperText={errorMessages(errors.deduction_component_name?.message)}
            required
          />
        </FormRow>
