...
export type ContributionListRef = {
  refreshContributionList: () => void;
};
  ...
  const dialogRenderer: DialogRenderer = {
    add: (
      <AddContributionDialog
        ...
        onAddSuccess={() =>
          contributionListRef.current?.refreshContributionList()
        }
      />
    ),
  };
    ...
    <>
      ...
      >
        <Stack>
          ...
          <ContributionList ref={contributionListRef} search={searchInput} />
        </Stack>
      </Box>
