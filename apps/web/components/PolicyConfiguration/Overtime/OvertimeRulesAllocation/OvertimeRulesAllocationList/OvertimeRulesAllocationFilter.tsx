...
import { useGetFilterListItemField } from "./Hooks/useGetOTfilterListItemFields";

type OvertimeRulesAllocationFilterProps = {
  filterListData?: FieldValues;
  setFilterListData: (data?: FieldValues) => void;
  clearSelection: () => void;
};
export const OvertimeRulesAllocationFilter = ({
  filterListData,
  setFilterListData,
  clearSelection,
}: OvertimeRulesAllocationFilterProps) => {
